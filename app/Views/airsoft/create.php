...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3">Airsoft Adding Form</h2>

            <form action="/airsoft/save" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="factory" name="factory" value="<?= old('factory'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5"> <select class="form-control" id="type" name="type" value="<?= old('type'); ?>">
